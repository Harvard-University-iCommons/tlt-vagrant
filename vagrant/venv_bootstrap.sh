...
pip install -r /vagrant/vagrant/requirements/icommons_lti_tools.txt

# Make ab-testing-tool virtualenv
mkvirtualenv -a /home/vagrant/ab-testing-tool ab-testing-tool
workon ab-testing-tool
pip install -r /home/vagrant/ab-testing-tool/ab_testing_tool/requirements/base.txt
pip install -r /vagrant/vagrant/requirements/ab_testing_tool.txt
